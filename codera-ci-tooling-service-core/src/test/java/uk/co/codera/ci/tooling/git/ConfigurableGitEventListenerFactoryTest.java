...
public class ConfigurableGitEventListenerFactoryTest {
    ...
    public void shouldBeAbleToRegisterListenerForPushType() {
        ...
        ConfigurableGitEventListenerFactory factory = newFactoryBuilder().register(GitPushType.ADD, newListener)
                .build();
    ...
    public void shouldFindAppropriateListenerAndInvokeOnPush() {
        ...
        ConfigurableGitEventListenerFactory factory = newFactoryBuilder().register(GitPushType.ADD, mockListener)
                .build();
