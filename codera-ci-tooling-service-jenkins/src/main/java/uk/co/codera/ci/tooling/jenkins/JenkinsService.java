...
public class JenkinsService {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(JenkinsService.class);
	...
	public JenkinsService(JenkinsConfiguration jenkinsConfiguration,
			JenkinsCommandLineInterfaceInvoker cliInvoker) {
	...
	public void createJob(String jobName, String jobDefinition) {
		...
		execute(CreateJobCommand.aCreateJobCommand().jobName(jobName)
				.jobDefinition(jobDefinition).with(this.jenkinsConfiguration));
	}
